...
assert_contains "$staging_dir/main.tf" 'repository_id[[:space:]]*=[[:space:]]*var\.artifact_registry_repository_id'
...
assert_contains "$staging_dir/main.tf" 'service_account_id[[:space:]]*=[[:space:]]*var\.backend_api_service_account_id'
assert_contains "$staging_dir/main.tf" 'service_account_roles[[:space:]]*=[[:space:]]*var\.backend_api_service_account_roles'
...
assert_contains "$staging_dir/main.tf" 'service_name[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_service_name'
assert_contains "$staging_dir/main.tf" 'container_image[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_container_image'
assert_contains "$staging_dir/main.tf" 'service_account_email[[:space:]]*=[[:space:]]*module\.backend_api_service_account\.service_account_email'
assert_contains "$staging_dir/main.tf" 'environment[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_environment'
assert_contains "$staging_dir/main.tf" 'min_instances[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_min_instances'
assert_contains "$staging_dir/main.tf" 'max_instances[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_max_instances'
assert_contains "$staging_dir/main.tf" 'memory[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_memory'
assert_contains "$staging_dir/main.tf" 'cpu[[:space:]]*=[[:space:]]*var\.backend_api_cloud_run_cpu'
