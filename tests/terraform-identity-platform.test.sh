...
assert_contains "$staging_dir/variables.tf" 'preview--ledger-muse\.asia-east1\.hosted\.app'
assert_contains "$staging_dir/variables.tf" 'production--ledger-muse\.asia-east1\.hosted\.app'
